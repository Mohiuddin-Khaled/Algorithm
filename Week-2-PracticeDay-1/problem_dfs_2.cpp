...
If we start Depth First Search (DFS) from node 1, it first visits node 2, then 3,
...
DFS proceeds sequentially through all the nodes in order.
The DFS traversal output is therefore 1, 2, 3, 4, 5, 6,
